...
public class SlashedObjectEffect : MonoBehaviour
{
    ...
    public void InitSlashSequence(SpriteRenderer obj)
    {
        SlashScreenWhiteout.instance.InitSlashWhiteout();
        InitSlashObject(obj, Color.white, 1);
    }

    //Used to initialize a slashed object effect
    void InitSlashObject(SpriteRenderer obj, Color col, float colStrength, float breakSpeed = 0.1f)
    {
        //Init Slope
